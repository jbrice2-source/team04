...
class LookMiro:
    ...
    def __init__(self):
        ...
        self.pub_kin = rospy.Publisher(base2 + "/control/kinematic_joints", JointState, queue_size=10)
        ...
        self.timer3 = rospy.Timer(rospy.Duration(0.001), self.publish_joints)
